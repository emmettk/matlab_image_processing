...
path = r'D:/RSEX17_TIFF/0926/20170926_1300_towerIR_towerEO/tower_IR_16mm/every_10th_tiff/'

###Load every nth file
n = 10
n = 1
for file in [file for file in os.listdir(path) if '.tif' in file][0::n]:
    p2 = r'D:/RSEX17_TIFF/Rectified/0926/20170926_1300_towerIR_towerEO/tower_IR_16mm_rectified_wo_interp/'
    output = p2 + file[:-4]+'_rectified.tif'
    print("reading into Matlab:", file)
#    eng.tiff_spatial_rectification(path+file, output, nargout = 0)
    eng.rectify_matrix_save_tiff(path+file, output, nargout = 0)
    print("wrote", output)
#    print(file, output)
